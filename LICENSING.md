...
AxonOS Consent — Dual Licence
=============================

This crate (axonos-consent) is licensed under your choice of either:
...
Documentation and specification text are additionally available under the
Creative Commons Attribution-ShareAlike 4.0 International licence
(CC-BY-SA-4.0; see LICENSE-CC-BY-SA). Conformance test vectors are dedicated
to the public domain under CC0-1.0 (see vectors/LICENSE).
